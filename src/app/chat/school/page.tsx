...
export default function SchoolChatPage() {
  ...
  const [conversations] = useState([
    {
      ...
      lastMessage: "Ok, saí da escola agora.",
      timestamp: "11:32",
      avatar: "CS",
    ...
    {
      id: 2,
      name: "Pedro Silva - Ajudante",
      lastMessage: "Todos os alunos embarcaram.",
      timestamp: "11:25",
      avatar: "PS",
    ...
    {
      id: 5,
      name: "João Oliveira - Motorista",
      lastMessage: "Tudo certo, aguardando.",
      timestamp: "2d atrás",
      avatar: "JO",
    ...
    {
      id: 6,
      name: "Patricia Costa - Mãe do Pedro",
      lastMessage: "Chegarei em 5 minutos.",
      timestamp: "Ontem",
      avatar: "PC",
  ...
  // Contatos disponíveis (motoristas, ajudantes e responsáveis)
  const [availableContacts] = useState([
    {
      id: 1,
      name: "Carlos Santos",
      role: "Motorista - Rota 5",
      description: "Responsável pela Rota 5",
      avatar: "CS",
      avatarColor: "from-blue-400 to-blue-600",
      isOnline: true,
      type: "driver",
    ...
    },
    {
      ...
      role: "Responsável",
      description: "Mãe do Lucas (8º ano - Turma A)",
      avatar: "AP",
      avatarColor: "from-pink-400 to-pink-600",
      isOnline: false,
      type: "parent",
    },
    {
      ...
      name: "Maria Silva",
      role: "Responsável",
      description: "Mãe da Julia (5º ano - Turma B)",
      avatar: "MS",
      avatarColor: "from-green-400 to-green-600",
      isOnline: false,
      type: "parent",
    },
    {
      ...
      description: "Responsável pela Rota 3",
      avatar: "JO",
      avatarColor: "from-purple-400 to-purple-600",
      isOnline: false,
      type: "driver",
    ...
    },
    {
      ...
      name: "Roberto Alves",
      role: "Ajudante",
      description: "Ajudante do João - Rota 3",
      avatar: "RA",
    ...
    },
    {
      ...
      name: "Patricia Costa",
      role: "Responsável",
      description: "Mãe do Pedro (6º ano - Turma C)",
      avatar: "PC",
      avatarColor: "from-orange-400 to-orange-600",
      isOnline: true,
      type: "parent",
